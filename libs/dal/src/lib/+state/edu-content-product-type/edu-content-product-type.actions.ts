...
export class EduContentProductTypesLoaded implements Action {
  readonly type =
    EduContentProductTypesActionTypes.EduContentProductTypesLoaded;

  constructor(
    public payload: { eduContentProductTypes: EduContentProductTypeInterface[] }
  ) {}
}

export class EduContentProductTypesLoadError implements Action {
  readonly type =
    EduContentProductTypesActionTypes.EduContentProductTypesLoadError;
...
export class AddEduContentProductType implements Action {
  ...
  constructor(
    public payload: { eduContentProductType: EduContentProductTypeInterface }
  ) {}
}
...
export class UpsertEduContentProductTypes implements Action {
  readonly type =
    EduContentProductTypesActionTypes.UpsertEduContentProductTypes;
...
export class UpdateEduContentProductType implements Action {
  ...
  constructor(
    public payload: {
      eduContentProductType: Update<EduContentProductTypeInterface>;
    }
  ) {}
}
...
export class UpdateEduContentProductTypes implements Action {
  readonly type =
    EduContentProductTypesActionTypes.UpdateEduContentProductTypes;

  constructor(
    public payload: {
      eduContentProductTypes: Update<EduContentProductTypeInterface>[];
    }
  ) {}
}
...
export class DeleteEduContentProductTypes implements Action {
  readonly type =
    EduContentProductTypesActionTypes.DeleteEduContentProductTypes;
