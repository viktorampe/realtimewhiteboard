import { ClassGroupQueries, GroupQueries, LearningAreaInterface, LearningAreaQueries, LinkedPersonQueries, TaskClassGroupQueries, TaskEduContentInterface, TaskEduContentQueries, TaskGroupQueries, TaskInterface, TaskQueries, TaskStudentQueries } from '@campus/dal';
