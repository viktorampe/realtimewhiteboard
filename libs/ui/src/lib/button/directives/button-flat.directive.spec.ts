...
import { FlatDirective } from './button-flat.directive';

@Component({
  // tslint:disable-next-line:component-selector
  selector: 'test-container',
  template: `
    <campus-button button-flat>tekst</campus-button>
  `
})
...
describe('FlatDirective', () => {
  ...
  beforeEach(() => {
    ...
    directive = componentDE.injector.get(FlatDirective);
  });
  ...
  it('should apply the correct class', () => {
    expect(componentDE.nativeElement.classList).toContain('ui-button--flat');
  });
});
