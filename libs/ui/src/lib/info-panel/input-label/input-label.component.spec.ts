...
describe('InfoPanelInputLabelComponent', () => {
  ...
  it('should show the text label', () => {
    const title = fixture.debugElement.query(
      By.css('.info-panel__input-label__text__label-holder__label')
    ).nativeElement.textContent;
    expect(title).toContain(mockData.text);
  });
  it('shoul not show the text label if the edit button was clicked', () => {
    fixture.debugElement
      .query(By.css('.info-panel__input-label__text__label-holder__edit-icon'))
  ...
  it('should not show the input if the edit icon is not clicked', () => {
    const input = fixture.debugElement.query(
      By.css('.info-panel__input-label__input-holder__input')
    );
  ...
  it('should hide input and show label when canceling edit', () => {
    ...
    fixture.detectChanges();
    fixture.debugElement
      .query(By.css('.info-panel__input-label__input-holder__icons-holder__cancel-icon'))
      .triggerEventHandler('click', null);
    fixture.detectChanges();
    const input = fixture.debugElement.query(
      By.css('.info-panel__input-label__input-holder__input')
  ...
  it('should pass the new text when saving', () => {
    ...
    fixture.debugElement
      .query(By.css('.info-panel__input-label__input-holder__icons-holder__confirm-icon'))
      .triggerEventHandler('click', null);
