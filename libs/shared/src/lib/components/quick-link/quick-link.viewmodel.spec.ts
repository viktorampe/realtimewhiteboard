      ...
      describe('getQuickLinkCategories$', () => {
              ...
              hot('a', {
                a: [
                  ...
                  // Exercise
                  {
                    ...
                    title: QuickLinkCategoryMap.get(mockFavorites[1].type)
                      .label,
                    order: QuickLinkCategoryMap.get(mockFavorites[1].type)
                      .order,
                    quickLinks: [
                      {
                        ...mockFavorites[1],
                  ...
                  // Task
                  {
                    ...
                    title: QuickLinkCategoryMap.get(mockFavorites[2].type)
                      .label,
                    order: QuickLinkCategoryMap.get(mockFavorites[2].type)
                      .order,
                    quickLinks: [
                      {
                        ...mockFavorites[2],
                  ...
                  // Bundle
                  {
                    ...
                    title: QuickLinkCategoryMap.get(mockFavorites[3].type)
                      .label,
                    order: QuickLinkCategoryMap.get(mockFavorites[3].type)
                      .order,
                    quickLinks: [
                      {
                        ...mockFavorites[3],
                  ...
                  // Boek-e
                  {
                    ...
                    title: QuickLinkCategoryMap.get(mockFavorites[4].type)
                      .label,
                    order: QuickLinkCategoryMap.get(mockFavorites[4].type)
                      .order,
                    quickLinks: [
                      {
                        ...mockFavorites[4],
                  ...
                  // Search
                  {
                    ...
                    title: QuickLinkCategoryMap.get(mockFavorites[5].type)
                      .label,
                    order: QuickLinkCategoryMap.get(mockFavorites[5].type)
                      .order,
                    quickLinks: [
                      {
                        ...mockFavorites[5],
        ...
        describe('individual quickLink', () => {
          ...
          const testCasesFavorites = [
            {
              ...
              expected: {
                category: {
                  title: QuickLinkCategoryMap.get(FavoriteTypesEnum.BUNDLE)
                    .label,
                  type: FavoriteTypesEnum.BUNDLE,
                  order: QuickLinkCategoryMap.get(FavoriteTypesEnum.BUNDLE)
                    .order
                },
                defaultAction: quickLinkActionDictionary.openBundle,
                alternativeOpenActions: [],
            ...
            },
            {
              ...
              expected: {
                category: {
                  title: QuickLinkCategoryMap.get(FavoriteTypesEnum.SEARCH)
                    .label,
                  type: FavoriteTypesEnum.SEARCH,
                  order: QuickLinkCategoryMap.get(FavoriteTypesEnum.SEARCH)
                    .order
                },
                defaultAction: quickLinkActionDictionary.openSearch,
                alternativeOpenActions: [],
            ...
            },
            {
              ...
              expected: {
                category: {
                  title: QuickLinkCategoryMap.get(FavoriteTypesEnum.BOEKE)
                    .label,
                  type: FavoriteTypesEnum.BOEKE,
          ...
          const testCasesHistory = [
            ...
            {
              describeName:
                'history - eduContent - not an exercise - streamable',
              setup: {
                quickLinkDataMode: QuickLinkTypeEnum.HISTORY,
                quickLinkType: FavoriteTypesEnum.EDUCONTENT,
                eduContentType: 'not an exercise',
