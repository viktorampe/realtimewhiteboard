...
describe('QuickLinkViewModel', () => {
  ...
  describe('streams', () => {
    ...
    describe('feedback', () => {
      ...
      it('should emit the error with the highest priority', () => {
        const feedBack1 = {
          ...mockFeedBack.updateFavoriteError,
          priority: Priority.NORM,
          timeStamp: 99 // older
        } as EffectFeedbackInterface;

        const feedBack2 = {
          ...mockFeedBack.deleteFavoriteError,
          priority: Priority.HIGH,
          timeStamp: 100
        } as EffectFeedbackInterface;
        ...
        [feedBack1, feedBack2, feedBack3].forEach(fB =>
          store.dispatch(
            new EffectFeedbackActions.AddEffectFeedback({
              effectFeedback: fB
            })
      ...
      it('should emit the oldest error (if priorities are equal)', () => {
        const feedBack1 = {
          ...mockFeedBack.updateFavoriteError,
          priority: Priority.HIGH,
          timeStamp: 101
